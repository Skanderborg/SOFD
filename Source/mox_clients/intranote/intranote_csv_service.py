...
class Intranote_csv_service:
    ...
    def create_orgunit_csv(self, csv_file_path):
        ...
        with open(csv_file_path + 'Orgenhed.csv', 'w', newline='', encoding='utf-8') as file:
    ...
    def create_users_csv(self, csv_file_path):
        ...
        with open(csv_file_path + 'Medarbejder.csv', 'w', newline='', encoding='utf-8') as file:
            writer = csv.writer(file, delimiter=";")
    ...
    def create_unic_csv(self, csv_file_path):
        ...
        with open(csv_file_path + 'Unilogin.csv', 'w', newline='', encoding='utf-8') as file:
            writer = csv.writer(file, delimiter=";")
