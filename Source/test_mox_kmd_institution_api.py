...
kmd_institution_test_primarykey = os.environ.get('kmd_institution_test_primarykey')
kmd_institution_employee_api_prod_primarykey = os.environ.get('kmd_institution_employee_api_prod_primarykey')
kmd_institution_api_prod_primarykey = os.environ.get('kmd_institution_api_prod_primarykey')
kmd_institution_employee_api_endpoint = os.environ.get('kmd_institution_employee_api_test_endpoint')
